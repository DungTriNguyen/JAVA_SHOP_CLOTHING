...
import QuanLySach.GUI.DlgDoiMatKhau;
import QuanLySach.GUI.PnQuanLyBanHangGUI;
import QuanLySach.GUI.PnQuanLyKhachHangGUI;
import QuanLySach.GUI.PnQuanLyKhuyenMaiGUI;
import QuanLySach.GUI.PnQuanLyNhanVienGUI;
import QuanLySach.GUI.PnQuanLyNhapHangGUI;
import QuanLySach.GUI.PnQuanLySanPhamGUI;
import QuanLySach.GUI.PnQuanLyThongKeGUI;
import QuanLySach.BUS.PhanQuyenBUS;
import QuanLySach.DTO.PhanQuyen;
...
public class MainQuanLyGUI extends JFrame {
    ...
    JLabel btnDoiMatKhau, lblTitleText;
    ...
    JLabel btnClose, btnMinimize, btnMaximize, lblBanHang, lblKhuyenMai, lblNhapHang, lblSanPham, lblNhanVien, lblKhachHang, lblThongKe;
    final Color clLeftItem = new Color(60, 100, 100);
    final Color clLeftItemHover = new Color(102, 205, 170);
    ...
    private void addControls() {
        ...
        pnTitle.setPreferredSize(new Dimension(this.getWidth(), 46));
        pnTitle.setBackground(new Color(60, 100, 100));

        btnDoiMatKhau = new JLabel(new ImageIcon("image/ManagerUI/btn-DoiMatKhau.png"));
        ...
        lblTitleText = new JLabel(new ImageIcon("image/ManagerUI/title-text.png"));
        lblTitleText.setBounds(width / 2 - 686 / 2, 3, 686, 38);
        pnTitle.add(lblTitleText);

        btnMinimize = new JLabel(new ImageIcon("image/ManagerUI/btn-minimize.png"));
        btnMinimize.setBounds(width - 125, 5, 38, 35);
        btnMinimize.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        pnTitle.add(btnMinimize);
        
        btnMaximize = new JLabel(new ImageIcon("image/ManagerUI/btn-maximize.png"));
        btnMaximize.setBounds(width - 85, 5, 38, 35);
        btnMaximize.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
        pnTitle.add(btnMaximize);
        ...
        lblAvatar.setPreferredSize(new Dimension(250, 250));
    ...
    private void addEvents() {
        ...
        btnDoiMatKhau.addMouseListener(new MouseListener() {
            ...
            public void mouseEntered(MouseEvent e) {
            	 btnDoiMatKhau.setIcon(new ImageIcon("image/ManagerUI/btn-DoiMatKhau--hover.png"));
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnDoiMatKhau.setIcon(new ImageIcon("image/ManagerUI/btn-DoiMatKhau.png"));
            }
        });
        
        btnMaximize.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
            	phongToFrame();
            }
            ...
            @Override
            public void mouseEntered(MouseEvent e) {
                btnMaximize.setIcon(new ImageIcon("image/ManagerUI/btn-maximize--hover.png"));
                
            }

            @Override
            public void mouseExited(MouseEvent e) {
                btnMaximize.setIcon(new ImageIcon("image/ManagerUI/btn-maximize.png"));
            }
        });
