...
import QuanLySach.DAO.SanPhamDAO;
...
public class SanPhamBUS {
    ...
    public boolean themSanPham(String ten,
        ...
        try {
            ...
            sp.setTenNhaXuatBan(tenNhaXuatBan);
...
//            int tenTG = Integer.parseInt(tenTacGia);
//            int tenNXB = Integer.parseInt(tenNhaXuatBan);
            ...
            if (tenTacGia.trim().equals("")) {
                new MyDialog("Tên tác Giả không được để rỗng!", MyDialog.ERROR_DIALOG);
                return false;
            }
            if (tenNhaXuatBan.trim().equals("")) {
                new MyDialog("Tên NXB không được để rỗng!", MyDialog.ERROR_DIALOG);
                return false;
            }
