...
import QuanLySach.DTO.NhanVien;
import QuanLySach.BUS.LoaiBUS;
import QuanLySach.BUS.NhanVienBUS;
import QuanLySach.BUS.HoaDonBUS;
import QuanLySach.BUS.CTHoaDonBUS;
...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    final Color colorPanel = new Color(254, 254, 254);
    ...
    private void addControlsBanHang() {
        ...
        dtmSanPhamBan.addColumn("TG");
        dtmSanPhamBan.addColumn("NXB");
        ...
        columnModelBanHang.getColumn(0).setPreferredWidth(35);
        columnModelBanHang.getColumn(1).setPreferredWidth(150);
        columnModelBanHang.getColumn(2).setPreferredWidth(70);
        columnModelBanHang.getColumn(3).setPreferredWidth(35);
        columnModelBanHang.getColumn(4).setPreferredWidth(35);
        columnModelBanHang.getColumn(5).setPreferredWidth(35);
        columnModelBanHang.getColumn(6).setPreferredWidth(100);
        columnModelBanHang.getColumn(7).setPreferredWidth(100);
//       
//        JScrollPane scrTblBanHang = new JScrollPane(tblBanHang);
        JScrollPane talkPane = new JScrollPane(tblBanHang,
...
//        //</editor-fold>
//        pnTableBanHang.add(tblBanHang);
        pnTableBanHang.add(talkPane,BorderLayout.CENTER);
        this.add(pnTableBanHang);
//        this.add(talkPane);
//        pnTableBanHang.add(scrTblBanHang, BorderLayout.CENTER);
//        pnTableBanHang.add(jPanel, BorderLayout.CENTER);
//-------------------------------------------
        ...
        dtmGioHang.addColumn("SL");
        dtmGioHang.addColumn("giá");
        ...
        columnModelGioHang.getColumn(0).setPreferredWidth(100);
        columnModelGioHang.getColumn(1).setPreferredWidth(250);
        columnModelGioHang.getColumn(2).setPreferredWidth(100);
        columnModelGioHang.getColumn(3).setPreferredWidth(100);
        ...
        pnLeftBanHang.setPreferredSize(new Dimension(1250, h - 250));
        pnTableBanHang.setPreferredSize(new Dimension(1250, (h - 50) / 2));
   ...
   private void loadDataTableSanPhamBan() {
    ...
    private void xuLyClickTblBanHang() {
        ...
        if (row > -1) {
            ...
            String tenTacGia = tblBanHang.getValueAt(row, 5) + "";
            String tenNhaXuatBan= tblBanHang.getValueAt(row, 6) + "";
    ...
    private void xuLyThemVaoGioHang() {
        ...
        vec.add(donGia);
        donGia = donGia.replace(",", "");
//        System.out.println("Giá trị của biến donGia: " + donGia);
        int donGiaSP = Integer.parseInt(donGia);
